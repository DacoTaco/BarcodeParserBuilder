...
public class HibcBarcode(AimSymbologyIdentifier? symbologyIdentifier, bool is2DBarcode) : Barcode(symbologyIdentifier)
{
    ...
    public bool Is2DBarcode { get; internal set; } = is2DBarcode;
...
internal class FixedLengthHibcField<T>(string identifier, int length) : HibcField<T>(identifier, length, length)
{
}

internal class HibcField(string identifier, int? maxLength = null) : HibcField<string?>(identifier, maxLength)
{
}

internal class FixedLengthHibcField(string identifier, int length) : FixedLengthHibcField<string?>(identifier, length)
{
}
