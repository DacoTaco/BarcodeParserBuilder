...
public class PpnBarcode(AimSymbologyIdentifier? identifier) : Barcode(identifier)
{
    ...
    internal class FixedLengthPpnField<T>(string identifier, int length) : PpnField<T>(identifier, length)
    {
    }

    internal class PpnField(string identifier, int? maxLength = null) : PpnField<string?>(identifier, maxLength)
    {
    }

    internal class FixedLengthPpnField(string identifier, int length) : FixedLengthPpnField<string?>(identifier, length)
    {
    }
}
