...
public class PpnBarcodeParserBuilderTestFixture : BaseBarcodeTestFixture
{
    ...
    public static TheoryData<string, PpnBarcode> ValidPpnParsingBarcodes() => new()
    {
        //Random Order #2
        {
    ...
    public static TheoryData<string?, PpnBarcode?> ValidPpnBarcodes()
    {
        ...
        return new TheoryData<string?, PpnBarcode?>()
        {
            //Empty string
            {
                null,
    ...
    public static TheoryData<string, string> InValidPpnBarcodes() => new()
    {
